...
namespace Autohand {
    ...
    public class Hand : HandBase {
        ...
        protected virtual void OnCollisionFirstEnter(GameObject collision, Collision collisionData) { //NOTE: collision parameter add by mbell 5/5/22
            if(collision.CanGetComponent(out HandTouchEvent touchEvent)) {
                touchEvent.Touch(this, collisionData);
            }
        }

        protected virtual void OnCollisionLastExit(GameObject collision, Collision collisionData) { //NOTE: collision parameter add by mbell 5/5/22
            if(collision.CanGetComponent(out HandTouchEvent touchEvent))
                touchEvent.Untouch(this, collisionData);
        }

        protected virtual void OnTriggerFirstEnter(GameObject other, Collision collisionData) { //NOTE: collision parameter add by mbell 5/5/22
        ...
        protected virtual void OnTriggerLastExit(GameObject other, Collision collisionData) { //NOTE: collision parameter add by mbell 5/5/22
